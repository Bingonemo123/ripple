'''
    ...
    volatility list from 06/07/2021 gives 81tpc

    old method list with traiding day difference on 07/07/2021 gives 96tpc. This is
    hieghest observed tcp till 12.08.2021 and will be used as goal. This list is not
    accesible  prior starting traygin in reality because inculde information from future. 
...
if __name__ == '__main__':
    try:
        ...
        past_time_assets =  ['NZDCHF', 'NZDCAD', 'USDCAD', 'USDCHF', 'NZDUSD', 'GBPCAD', 'AUDCHF', 'NZDJPY', 'GBPJPY', 'CADCHF', 'GBPUSD', 'USDJPY', 'AUDCAD', 'CADJPY', 'AUDJPY', 'CHFJPY', 'EURCHF', 'AUDUSD', 'EURAUD', 'EURCAD', 'EURJPY', 'EURUSD', 'AUDNZD', 'EURGBP', 'EURNZD']# input

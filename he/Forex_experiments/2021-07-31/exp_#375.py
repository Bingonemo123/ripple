"""
    ...
    old method:  ['GBPCAD', 'AUDCAD', 'AUDCHF', 'USDCAD', 'NZDCAD', 'EURCHF', 'USDCHF', 'EURCAD', 'NZDCHF', 'GBPUSD', 'AUDNZD', 'AUDUSD', 'EURNZD', 'GBPJPY', 'AUDJPY', 'NZDUSD', 'EURUSD', 'CADCHF', 'NZDJPY', 'EURAUD', 'USDJPY', 'EURGBP', 'EURJPY', 'CHFJPY', 'CADJPY']
    ...
    list on day after(07/07/2021 -- trading day):
    old method: ['NZDCHF', 'NZDCAD', 'USDCAD', 'USDCHF', 'NZDUSD', 'GBPCAD', 'AUDCHF', 'NZDJPY', 'GBPJPY', 'CADCHF', 'GBPUSD', 'USDJPY', 'AUDCAD', 'CADJPY', 'AUDJPY', 'CHFJPY', 'EURCHF', 'AUDUSD', 'EURAUD', 'EURCAD', 'EURJPY', 'EURUSD', 'AUDNZD', 'EURGBP', 'EURNZD']
    new method: ['GBPJPY', 'EURJPY', 'CHFJPY', 'NZDJPY', 'AUDJPY', 'CADJPY', 'USDJPY', 'EURNZD', 'GBPCAD', 'EURAUD', 'EURCAD', 'GBPUSD', 'USDCAD', 'NZDUSD', 'AUDUSD', 'EURUSD', 'NZDCAD', 'AUDCAD', 'USDCHF', 'AUDNZD', 'CADCHF', 'NZDCHF', 'AUDCHF', 'EURGBP', 'EURCHF']

    Should be mentioned that volatility lists don't differ much tough out the days.
"""
import datetime 
import os
import shutil

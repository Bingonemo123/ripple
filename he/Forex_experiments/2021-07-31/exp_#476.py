...
if __name__ == '__main__':
    try:
        ...
        past_time_assets = ['USDCAD', 'NZDCAD', 'GBPCAD', 'EURCAD', 'AUDCAD', 'USDCHF', 'EURAUD', 'NZDCHF', 'EURGBP', 'EURNZD', 'EURCHF', 'AUDCHF', 'NZDUSD', 'AUDNZD', 'USDJPY', 'EURUSD', 'GBPUSD', 'AUDUSD', 'NZDJPY', 'CHFJPY', 'GBPJPY', 'EURJPY', 'AUDJPY', 'CADCHF', 'CADJPY']# input
